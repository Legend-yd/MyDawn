...
package com.ly.clusterutil.clustering.view;
...
import com.ly.clusterutil.MarkerManager;
import com.ly.clusterutil.clustering.Cluster;
import com.ly.clusterutil.clustering.ClusterItem;
import com.ly.clusterutil.clustering.ClusterManager;
import com.ly.clusterutil.projection.Point;
import com.ly.clusterutil.projection.SphericalMercatorProjection;
import com.ly.clusterutil.ui.IconGenerator;

import static com.ly.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem>
		implements com.ly.clusterutil.clustering.view.ClusterRenderer<T> {
	...
	private com.ly.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
		com.ly.clusterutil.ui.SquareTextView squareTextView = new com.ly.clusterutil.ui.SquareTextView(context);
